...
[Skeleton css](http://getskeleton.com/) is a "a dead simple, responsive" CSS framework focused on mobile-first design and a minimalistic approach.
...
<a hreaf = "https://connect.thinkr.fr/prenoms/" target = "_blank"><img src = "prenomsapp.png" width = "100%"></a>
...
golem::create_golem(
  "skdashboard",
  project_hook = skeleton::skeleton::ghook_sk_boilerplate
)
```
